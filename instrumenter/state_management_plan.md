...
## Case 1: Continuation point is a SuspendPoint
```java
...
```java
Object[] duplicatedArgs = saveOperandStack(<method param count>); 
    // Why do we do this? because when we want to save the
